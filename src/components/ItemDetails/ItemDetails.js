...
const initData = {
  itemImg: "/vids/card1_1.mp4",
  date: "2022-03-30",
  tab_1: "Bids",
  tab_2: "History",
  tab_3: "Details",
  ownerImg: "/img/author_1.png",
  itemOwner: "Nereus",
  created: "15 Jul 2021",
  title: "Cards",
  content:
            ...
            <div className="col-12 col-lg-5">
              <div className="item-info">
                <div className="item-thumb text-center">
                  <video width="500" height="400" autoPlay="true">
                    <source src={this.state.initData.itemImg} type="video/mp4" />
                  </video>
